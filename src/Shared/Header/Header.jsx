      ...
      <div className="navbar-end">
        ...
        {user ? (
          <Link
            ...
            className="btn font-bold bg-purple-400 border-none text-white hover:bg-purple-600 mobile-logout"
          >
            Logout
          </Link>
        ) : (
          <div>
            <Link
              to="/login"
              className="font-bold mr-3 mb-1 bg-purple-500 border-none  hover:bg-purple-600 forMblLink py-3 px-4 rounded text-white mobile-login"
            >
              Login
            </Link>
            <Link
              to="/register"
              className="font-bold mobile-register bg-purple-500 border-none hover:bg-purple-600 forMblLink py-3 px-4 rounded text-white"
            >
              Register
            </Link>
          </div>
